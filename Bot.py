...
# ==================== CONFIGURATION ====================
BOT_TOKEN = "8737017483:AAGgMwfVu_tt7nkY6MCIoUcMxmoQKXEqCPM"  # ✅ Your token added
...
📋 *Last 15:* {' '.join(r.get('size') for r in last_results[:15])}
    """
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "gen":
        ...
        # For history callback, we need to send new message
        session = SessionManager.load()
        history = session.get("history", [])
